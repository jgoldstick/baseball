...
urlpatterns = [
    ...
    url(r'^teams/standings/$', views.teams, name='teams'),
    url(r'^teams/standings/(?P<year>\d{4})/$', views.teams, name='teams'),
    ...
    url(r'^teams/(?P<team_id>\d{4}\w{3})/$', views.team_year, name='team_year'),
